"""
Centralized configuration settings for the FinOps Agent MCP Server.
"""
...
# =======================================================================================
# 3. Secret Manager Helper Functions
# =======================================================================================
...
if not GOOGLE_PROJECT_ID:
    # Fallback for local dev if secrets aren't accessible but env var is set
    if os.environ.get("GOOGLE_PROJECT_ID"):
        GOOGLE_PROJECT_ID = os.environ.get("GOOGLE_PROJECT_ID")
    else:
        logging.warning("Could not determine Google Cloud Project ID from secrets or default auth.")
...
EARB_DESIGNDOCS = _fetch_config("rag-earb-designdocs")
...
# =======================================================================================
# 5. Initialize Google Cloud Services
# =======================================================================================
